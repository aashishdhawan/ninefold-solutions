...
You can use the controller search option, `-c`, to view routes one controller at a time, and remove unused routes by restricting route creation.

## Removing used or incomplete features
